 ...
 * System IO Config
 */
#define CONFIG_SYS_SICRL (SICRL_DMA_CH0)
#define CONFIG_SYS_SICRH (SICRH_GPIO_0 |\
			SICRH_GPIO_1 |\
			SICRH_GPIO_2 |\
			SICRH_GPIO_3 |\
			SICRH_GPIO_4 |\
...
#define CONFIG_SYS_FLASH_SIZE		1 /* FLASH size in MB */
#define CONFIG_SYS_FLASH_PROTECTION	1		/* Use h/w Flash protection. */

#define CONFIG_SYS_LBLAWBAR0_PRELIM	CONFIG_SYS_FLASH_BASE /* Window base at flash base */
#define CONFIG_SYS_LBLAWAR0_PRELIM	0x80000016 /* 1MB window size */
...
//#define MTDIDS_DEFAULT			"nor1=boot-1,nand1=kernel-1,nand2=root-2,nand3=user-3"
...
#define CONFIG_SYS_I2C_BOARD_LATE_INIT
 ...
 */
#define CONFIG_RGMII		1 /* MII PHY management */
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
   "netdev=eth0\0"							\
   "consoledev=ttyS0\0"							\
   "bootfile=cuImage.mpc8315erdb\0"			\
   "ramdiskaddr=1000000\0"						\
   "ramdiskfile=rootfs.jffs2\0"						\
   "fdtaddr=780000\0"							\
   "fdtfile=mpc8315erdb.dtb\0"						\
   "ipaddr=192.168.0.232\0"\
   "ethaddr=01:02:03:04:05:06\0"\
   "eth1addr=01:02:03:04:05:7\0"\
   "netmask=255.255.255.0\0"\
   "serverip=192.168.0.92\0"\
   "gatewayip=192.168.0.1\0"\
   "bootargs=console=/dev/ttyS0,115200 mtdparts=nor0:-(uboot);nand0:16M(linux),128M(root),-(user)\0"\
   "usb_phy_type=utmi\0"						\
   ""
